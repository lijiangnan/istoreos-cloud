...
download() {
    ...
    local img=`wget -O- https://openwrt.mpdn.fun:8443/?dir=lede/x86_64/2025-02-06__05-23-24--plus-daily| head -1 | sed -E 's/.*\((.+)\).*/\1/'`
    [ -z "$img" ] && exit 1
    wget -O $IMAGE "https://openwrt.mpdn.fun:8443/?dir=lede/x86_64/$img" || exit 1
}
